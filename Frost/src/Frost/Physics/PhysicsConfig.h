...
namespace Frost
{
    ...
    public:
        /// Constructor
        explicit SpecifiedBroadPhaseLayerFilter(JPH::BroadPhaseLayer inLayer) : mLayer(inLayer) {}

        // See BroadPhaseLayerFilter::ShouldCollide
        virtual bool ShouldCollide(JPH::BroadPhaseLayer inLayer) const override { return mLayer == inLayer; }
    ...
    {
    public:
        explicit SpecifiedObjectLayerFilter(JPH::ObjectLayer inLayer) : mLayer(inLayer) {}
        virtual bool ShouldCollide(JPH::ObjectLayer inLayer) const override { return mLayer == inLayer; }
