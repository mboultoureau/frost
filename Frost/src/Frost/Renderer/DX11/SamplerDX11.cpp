...
namespace Frost
{
	D3D11_FILTER ToD3D11Filter(Filter filter)
	{
		switch (filter)
		{
		case Filter::MIN_MAG_MIP_POINT:               return D3D11_FILTER_MIN_MAG_MIP_POINT;
		case Filter::MIN_MAG_POINT_MIP_LINEAR:        return D3D11_FILTER_MIN_MAG_POINT_MIP_LINEAR;
		case Filter::MIN_POINT_MAG_LINEAR_MIP_POINT:  return D3D11_FILTER_MIN_POINT_MAG_LINEAR_MIP_POINT;
		case Filter::MIN_POINT_MAG_MIP_LINEAR:        return D3D11_FILTER_MIN_POINT_MAG_MIP_LINEAR;
		case Filter::MIN_LINEAR_MAG_MIP_POINT:        return D3D11_FILTER_MIN_LINEAR_MAG_MIP_POINT;
		case Filter::MIN_LINEAR_MAG_POINT_MIP_LINEAR: return D3D11_FILTER_MIN_LINEAR_MAG_POINT_MIP_LINEAR;
		case Filter::MIN_MAG_LINEAR_MIP_POINT:        return D3D11_FILTER_MIN_MAG_LINEAR_MIP_POINT;
		case Filter::MIN_MAG_MIP_LINEAR:              return D3D11_FILTER_MIN_MAG_MIP_LINEAR;
	...
	D3D11_TEXTURE_ADDRESS_MODE ToD3D11AddressMode(AddressMode mode)
	{
		switch (mode)
		{
	...
	SamplerDX11::SamplerDX11(const SamplerConfig& config)
		: _config(config)
	{
