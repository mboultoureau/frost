...
namespace Frost
{
    ...
    void ScreenShakeEffect::OnImGuiRender(float deltaTime)
    {
        ...
        if (_currentTime > 0.0f)
        {
            ...
            {
                case AttenuationType::Linear:
                    currentAttenuationName = "Linear";
                    break;
                case AttenuationType::EaseOut:
                    currentAttenuationName = "EaseOut";
                    break;
                case AttenuationType::EaseIn:
                    currentAttenuationName = "EaseIn";
                    break;
                case AttenuationType::Constant:
                    currentAttenuationName = "Constant";
                    break;
            }
        }
        ...
        drawList->AddRectFilled(
            canvasPos, ImVec2(canvasPos.x + canvasSize.x, canvasPos.y + canvasSize.y), IM_COL32(30, 30, 30, 255));
        drawList->AddLine(ImVec2(canvasPos.x, canvasPos.y + canvasSize.y / 2),
                          ImVec2(canvasPos.x + canvasSize.x, canvasPos.y + canvasSize.y / 2),
