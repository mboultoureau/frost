	...
	void DebugInput::_DrawKeyboardPanel()
	{
		if (ImGui::TreeNode("Keyboard"))
		{
			auto GetKeyStateString = [](KeyState state) -> const char*
			{
				switch (state)
				{
				case KeyState::DOWN:     return "DOWN (Pressed)";
				case KeyState::REPEATED: return "HOLDING";
				case KeyState::UP:       return "IDLE/UP";
				default:                        return "UNKNOWN";
				}
			};
			...
			for (int i = 1; i <= 24; ++i)
			{
				DrawKeyState((VirtualKeyCode)(VirtualKeyCode::K_F1 + i - 1),
